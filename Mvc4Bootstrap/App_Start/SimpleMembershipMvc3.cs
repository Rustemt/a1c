...
[assembly: WebActivator.PreApplicationStartMethod(typeof(A1fxCrm.Web.App_Start.SimpleMembershipMvc3), "Start")]
[assembly: WebActivator.PostApplicationStartMethod(typeof(A1fxCrm.Web.App_Start.SimpleMembershipMvc3), "Initialize")]

namespace A1fxCrm.Web.App_Start
{
	public static class SimpleMembershipMvc3
	{
		...
		public static void Initialize()
		{
			...
			//WebSecurity.InitializeDatabaseConnection(connectionStringName: "Default", userTableName: "Users", userIdColumn: "ID", userNameColumn: "Username", autoCreateTables: false);
